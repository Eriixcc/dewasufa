...
<body>
        ...
        <div class="container">
            <div class="welcome-grid">
                ...
                <div class="welcome-content">
                    <span class="section-tag-pill">Tentang Dewasufa</span>
    ...
    <div class="modal-overlay" id="dest-modal" role="dialog" aria-modal="true" aria-labelledby="dest-modal-title">
        <div class="modal-box dest-modal-box">
            ...
            <div class="modal-header dest-modal-header">
                <span id="dest-modal-badge" class="section-tag-pill">Waterfall</span>
